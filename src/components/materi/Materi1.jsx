...
function Materi1(){
    ...
    const textChangeHandler = (event) => {
        console.log(event.nativeEvent.data); // cuma coba2 untuk menampilkan data yang lebih spesifik
        ...
        <div className="p-5">
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="Input" placeholder="Inputkan 3 kata" onChange={textChangeHandler}/>
                </div>
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="Inpu3" placeholder="Kata yang diketikan akan di kirim kesamping" onChange={(e) => setMessage2(e.target.value)}/>
                </div>
                <div className="col-md-6 d-flex justify-content-start">
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="Inpu2" placeholder="Jika tidak diisi maka button akan disable" onChange={textDisableHandler}/>
                </div>
                <div className="col-md-6 d-flex justify-content-start">
