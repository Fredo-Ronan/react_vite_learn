                    ...
                    <div className="d-flex justify-content-start align-item-center">
                        <div>
                            <h5 className="text-start mb-3 mt-2">
                                Contoh Lain Penggunaan UseState
                            </h5>
                ...
                <div className="col-md-6">
                    <form className="p-2" onSubmit={submitHandler}>
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="text" className="form-control" id="validationCustom01" value={namaMatakuliah} onChange={(e)=>setNamaMatakuliah(e.target.value)}required/>
                        </div>
                        <div className="col-md-6">
                            <label htmlFor="validationCustom02" className="form-label d-block text-start">
                                Nama Dosen
                            </label>
                            <input type="text" className="form-control" id="validationCustom02" required value={namaDosen} onChange={(e)=>setNamaDosen(e.target.value)}/>
                        </div>
